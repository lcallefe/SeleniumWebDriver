...
import java.net.URL;
public class REQ04CT03CadastroRAVazioTest {
  ...
  @Test
  public void rEQ04CT03CadastroRAVazio() {
    driver.get("https://ts-scel.herokuapp.com/");
    driver.manage().window().setSize(new Dimension(1074, 680));
    driver.findElement(By.linkText("Livros")).click();
    driver.findElement(By.id("autor")).click();
    driver.findElement(By.id("autor")).sendKeys("Epiteto");
    driver.findElement(By.id("titulo")).click();
    driver.findElement(By.id("titulo")).sendKeys("A Arte de Viver");
