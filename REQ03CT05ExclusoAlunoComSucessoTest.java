...
import java.net.URL;
public class REQ03CT05ExclusoAlunoComSucessoTest {
  ...
  @Test
  public void rEQ03CT05ExclusoAlunoComSucesso() {
    ...
    assertThat(driver.findElement(By.cssSelector("tr:nth-child(2) > td:nth-child(4)")).getText(), is("johndoe@gmail.com"));
    driver.findElement(By.cssSelector("tr:nth-child(2) .delete")).click();
    assertThat(driver.findElement(By.cssSelector("td:nth-child(4)")).getText(), is("jose@gmail.com"));
  }
}
