...
import java.net.URL;
public class REQ09CT01LoginJoseTest {
  ...
  @Test
  public void rEQ09CT01LoginJose() {
    ...
    assertThat(driver.findElement(By.cssSelector("h3:nth-child(2)")).getText(), is("Registrar/Consultar Empréstimo de Livro"));
