...
import java.net.URL;
public class REQ04CT01CadastroRAAlunoMenorTest {
  ...
  @Test
  public void rEQ04CT01CadastroRAAlunoMenor() {
    ...
    driver.findElement(By.id("nome")).sendKeys("Maria de Souza");
    driver.findElement(By.id("email")).click();
    driver.findElement(By.id("email")).sendKeys("maria@hotmail.com");
    driver.findElement(By.id("cep")).click();
    driver.findElement(By.id("cep")).sendKeys("09621010");
