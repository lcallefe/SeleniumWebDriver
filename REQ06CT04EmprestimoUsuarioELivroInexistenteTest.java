...
import java.net.URL;
public class REQ06CT04EmprestimoUsuarioELivroInexistenteTest {
  ...
  @Test
  public void rEQ06CT04EmprestimoUsuarioELivroInexistente() {
    ...
    driver.findElement(By.id("ra")).sendKeys("RA12");
