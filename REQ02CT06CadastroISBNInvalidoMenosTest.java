...
import java.net.URL;
public class REQ02CT06CadastroISBNInvalidoMenosTest {
  ...
  @Test
  public void rEQ02CT06CadastroISBNInvalidoMenos() {
    ...
    driver.findElement(By.id("titulo")).sendKeys("Memórias Póstumas de Brás Cubas");
