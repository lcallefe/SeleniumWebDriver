...
public class REQ03CT01CadastroAlunoComSucessoTest {
  ...
  public void rEQ03CT01CadastroAlunoComSucesso() {
    ...
    driver.findElement(By.id("ra")).sendKeys("1997");
    ...
    assertThat(driver.findElement(By.cssSelector("tr:nth-child(2) > td:nth-child(3)")).getText(), is("Luciana Callefe Donadio"));
